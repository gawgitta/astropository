...
{
	public class ISSpear : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!projOwner.frozen)
			{
				...
				if (projOwner.itemAnimation < projOwner.itemAnimationMax / 1.9) // Somewhere along the item animation, make sure the spear moves back
				{
					movementFactor -= 2.4f;
				}
